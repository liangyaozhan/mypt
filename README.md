...
# ./a
thread a1 started
 *** thread a1 delay1 1000ms n=0 tick=0
thread a2 started
 *** thread a2 delay1 1000ms n=0 tick=0
thread b1 started
thread b1 delay 500ms for-loop 0
thread b.a1 started
 *** thread b.a1 delay1 1000ms n=0 tick=0
thread b.a2 started
 *** thread b.a2 delay1 1000ms n=0 tick=0
thread b1 delay 500ms for-loop 1
thread b1 delay 500ms for-loop 2
thread b1 delay 500ms for-loop 3
thread b1 delay 500ms for-loop 4
thread b1 delay 500ms for-loop 5
thread b1 delay 500ms for-loop 6
thread b1 delay 500ms for-loop 7
thread b1 delay 500ms for-loop 8
thread b1 delay 500ms for-loop 9
thread b1 delay 5000ms done 0

-- thread a2 txsize=16
-- thread b.a1 txsize=16
-- thread b.a2 txsize=16
-- thread a1 txsize=16
 *** thread b.a1 delay1 1000ms n=1 tick=1102
 *** thread b.a2 delay1 1000ms n=1 tick=1102
 *** thread a1 delay1 1000ms n=1 tick=1102
 *** thread a2 delay1 1000ms n=1 tick=1102
-- thread b.a1 txsize=16
-- thread b.a2 txsize=16
-- thread a1 txsize=16
-- thread a2 txsize=16
 *** thread b.a1 delay1 1000ms n=2 tick=2204
 *** thread b.a2 delay1 1000ms n=2 tick=2204
 *** thread a1 delay1 1000ms n=2 tick=2204
 *** thread a2 delay1 1000ms n=2 tick=2204
-- thread b.a1 txsize=16
-- thread b.a2 txsize=16
-- thread a1 txsize=16
-- thread a2 txsize=16
 *** thread b.a2 delay1 1000ms n=3 tick=3306
 *** thread a1 delay1 1000ms n=3 tick=3306
 *** thread a2 delay1 1000ms n=3 tick=3306
 *** thread b.a1 delay1 1000ms n=3 tick=3306
