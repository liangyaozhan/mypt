...
```bash
# ./myptm.exe
entering my_thread_entry_a p=0x7ffffcac0
thread a1 started
-- thread a1 txsize=355
entering my_thread_entry_a p=0x7ffffca30
thread a2 started
-- thread a2 txsize=355
thread b1 started
thread b1 delay 500ms for-loop 0
entering my_thread_entry_a p=0x7ffffc478
thread b.a1 started
-- thread b.a1 txsize=355
entering my_thread_entry_a p=0x7ffffc500
thread b.a2 started
-- thread b.a2 txsize=355
 ------------ sleep 49ms ------------------
...
#########  rx_size=16
 ########    message queue  msg recv from thread a1 value=0
#########  rx_size=16
 ########    message queue  msg recv from thread a2 value=0
#########  rx_size=16
 ########    message queue  msg recv from thread b.a1 value=0
#########  rx_size=16
 ########    message queue  msg recv from thread b.a2 value=0
#########  rx_size=16
 ########    message queue  msg recv from thread a2 value=0
#########  rx_size=16
 ########    message queue  msg recv from thread a2 value=0
